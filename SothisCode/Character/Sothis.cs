...
public class Sothis : PlaceholderCharacterModel
{
    ...
    public override RelicPoolModel RelicPool => ModelDb.RelicPool<SothisRelicPool>();
    public override PotionPoolModel PotionPool => ModelDb.PotionPool<SothisPotionPool>();
